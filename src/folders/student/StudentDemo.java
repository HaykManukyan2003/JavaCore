...
public class StudentDemo {
    ...
    public static void main(String[] args) {
        ...
        while (isRunning) {
            ...
            System.out.println("Input 1 to add a folders.student.");
            System.out.println("Input 2 to display all students.");
            System.out.println("Input 3 to display folders.student count.");
            System.out.println("Input 4 to delete folders.student by index.");
            System.out.println("Input 5 to display folders.student by lesson.");
            System.out.println("Input 6 to change folders.student's lesson.");
            System.out.print("\n");
            ...
            switch (command) {
                ...
                case 4:
                    storage.display();
                    System.out.println("choose index to delete the corresponding folders.student object");
                ...
                case 6:
                    storage.display();
                    System.out.println("choose index to change the corresponding folders.student's lesson");
    ...
    private static void addStudent() {
        System.out.println("Input folders.student's name:");
        String name = scanner.nextLine();

        System.out.println("Input folders.student's surname:");
        String surname = scanner.nextLine();

        System.out.println("Input folders.student's age:");
        int age;
        try {
        ...
        System.out.println("Input folders.student's phoneNumber:");
        int phoneNumber;
        ...
        System.out.println("Input folders.student's city:");
        String city = scanner.nextLine();

        System.out.println("Input folders.student's lesson:");
